...
{
    private var _classUnderTest:ProcessProvider;


    [Before]
    public function before():void
    {
        _classUnderTest = new ProcessProvider();
    }
    ...
    {
        const process:Process = _classUnderTest.get( ProcessName.ONE )
        assertThat(
                _classUnderTest.get( ProcessName.ONE ),
    ...
    {
        const subProcess:SubProcess = new SubProcess( [StateName.TARGET, StateName.CURRENT, StateName.ONE] );
